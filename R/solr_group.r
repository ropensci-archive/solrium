...
#' solr_group(q='ecology', group.field='journal', group.limit=3, fl=c('id','score'), url=url)
...
#' out <- solr_group(q='ecology', group.field=c('journal','article_type'), group.limit=3, fl='id', url=url, raw=TRUE)
#' solr_parse(out)
#' solr_parse(out, 'df')
#' 
